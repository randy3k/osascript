...
tell application "System Events" to tell (process 1 where frontmost is true)
	...
	if my approx(windowWidth, 0.6 * screenWidth) and my approx(windowX, originX + screenWidth * 0.4) then
	...
	else if my approx(windowWidth, 0.4 * screenWidth) and my approx(windowX, originX + screenWidth * 0.6) then
	...
	else if my approx(windowWidth, 0.5 * screenWidth) and my approx(windowX, originX + screenWidth * 0.5) then
